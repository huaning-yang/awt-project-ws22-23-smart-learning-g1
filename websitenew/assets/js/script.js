  ...
  xhttp.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
      ...
      for (var j = 0; j < coursesResponse.length; j++) {
        ...
        divProject.style.minHeight = "240px";
        divProject.style.maxHeight = "240px";
        var h3Item = document.createElement("h3");
        h3Item.innerHTML = course.course_name;
        // var h4Item = document.createElement("h4");
        // h4Item.innerHTML = "Short description";
        var small1Item = document.createElement("small");
        small1Item.innerHTML = "Date: " + course.course_datetime;
        var small2Item = document.createElement("small");
        small2Item.innerHTML = "Location: " + course.course_location;
...
function updateExistingCompetencies() {
  ...
  // console.log(exisitingCompetencies)
